...
void apply_veh_patches() {
    ...
    //patch the patches from the patching of the patch
    build_patch(0x00505FC0, {0x36, 0x28, 0x95, 0x00, 0x85, 0xD2, 0x74}, 0, new_VEH_addr + 0xE);
    build_patch(0x00505FCE, {0x56, 0x28, 0x95, 0x00, 0x85, 0xC0, 0x7D}, 0, new_VEH_addr + 0x2E);
    build_patch(0x00505FD9, {0x2A, 0x28, 0x95, 0x00, 0x0F, 0xBF, 0x8B}, 0, new_VEH_addr + 0x2);
    build_patch(0x006185AA, {0x56, 0x28, 0x95, 0x00, 0x85, 0xD2, 0x7C}, 0, new_VEH_addr + 0x2E);
    build_patch(0x006185BE, {0x39, 0x28, 0x95, 0x00, 0x18, 0x8B, 0xF0}, 0, new_VEH_addr + 0x11);
    build_patch(0x00618626, {0x28, 0x28, 0x95, 0x00, 0x89, 0x3D, 0x78}, 0, new_VEH_addr + 0x0);
    build_patch(0x00618677, {0x3A, 0x28, 0x95, 0x00, 0xC3, 0xB9, 0xB0}, 0, new_VEH_addr + 0x12);
    build_patch(0x006392E9, {0x2A, 0x28, 0x95, 0x00, 0x8B, 0x35, 0xF0}, 0, new_VEH_addr + 0x2);
    build_patch(0x0063E85E, {0x36, 0x28, 0x95, 0x00, 0x89, 0x55, 0xF4}, 0, new_VEH_addr + 0xE);
    build_patch(0x0063E88A, {0x39, 0x28, 0x95, 0x00, 0x00, 0x0F, 0xBF}, 0, new_VEH_addr + 0x11);
    build_patch(0x0063E892, {0x32, 0x28, 0x95, 0x00, 0x42, 0xC3, 0x85}, 0, new_VEH_addr + 0xA);
}